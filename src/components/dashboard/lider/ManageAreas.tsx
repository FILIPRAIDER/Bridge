    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-2xl p-8 shadow-md relative overflow-hidden">
        ...
        <div className="relative flex flex-col gap-4">
          ...
          {/* Botones responsive: se apilan en mobile, lado a lado en desktop */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <button
              onClick={() => setShowAIInsights(true)}
              className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-purple-600 to-purple-500 text-white rounded-lg hover:from-purple-500 hover:to-purple-400 transition-all text-sm font-medium shadow-lg border border-purple-400/30 backdrop-blur-sm"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-5 py-3 bg-gradient-to-r from-gray-700 to-gray-600 text-white rounded-lg hover:from-gray-600 hover:to-gray-500 transition-all text-sm font-medium shadow-lg border border-gray-500/30 backdrop-blur-sm"
            >
