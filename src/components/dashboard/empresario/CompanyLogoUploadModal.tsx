...
export function CompanyLogoUploadModal({
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      formData.append("fileName", `logo_${companyId}_${Date.now()}`);

      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/uploads/companies/${companyId}/logo`,
        {
          method: "POST",
          body: formData,
        }
      ...
      show({
        title: "¡Listo!",
        message: "Logo de la empresa actualizado exitosamente",
        variant: "success",
      });
      ...
      show({
        title: "Error",
        message: error.message || "Error al subir el logo de la empresa",
        variant: "error",
      });
    } finally {
          ...
          <div className="p-6">
            ...
            <div className="flex justify-center mb-6">
              <div className="relative">
                <div className="h-40 w-40 rounded-2xl bg-gray-100 flex items-center justify-center overflow-hidden ring-4 ring-gray-300">
                  {previewUrl ? (
                    <img
                      src={previewUrl}
                      alt="Preview"
            ...
            >
              <div className="flex flex-col items-center justify-center text-center">
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Se recomienda un logo cuadrado o con fondo transparente
                </p>
              </div>
            </div>
            ...
            >
              {isUploading ? (
                ...
                <>
                  ...
                  {currentLogoUrl ? "Actualizar Logo" : "Subir Logo"}
                </>
              )}
            </button>
          </div>
